...
class JadwalLatihanPenggantiScreen extends StatefulWidget {
  final User user; // Menggunakan model User yang memiliki role

  const JadwalLatihanPenggantiScreen({super.key, required this.user});

  @override
  State<JadwalLatihanPenggantiScreen> createState() =>
      _JadwalLatihanPelatihScreenState();
}

class _JadwalLatihanPelatihScreenState
    extends State<JadwalLatihanPenggantiScreen> {
